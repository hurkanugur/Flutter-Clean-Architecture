...
class WeatherDetailsAppBar extends ConsumerWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AdvancedAppBar(
      title: localizationController.translateText(textType: TextType.weatherDetails),
